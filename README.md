...
This folder contains the [Project TIER](https://www.projecttier.org) demo project *Money, Happiness and the Midlife Crisis* translated into RMarkdown by [Johannes Karreth](www.jkarreth.net). The project follows the [TIER Documentation Protocol v3.0 for R](https://github.com/ProjectTIER/ProjectTIER_R), with minor changes to adjust for using RMarkdown with self-contained R code. Protocol v3.0 is explained in more detail below.
